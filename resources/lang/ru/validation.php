...
return [
   ...
   */
    ...
    */
	...
	'custom' => [
		'name' => [
			'required' => 'Поле '.trans('forms.name').' обязательно для заполнения.',
			'max'      => 'Значение поля '.trans('forms.name').' должно быть до :max символов.',
			'min'      => 'Значение поля '.trans('forms.name').' должно быть от :min символов.',
		],
		'email' => [
			'email' => 'Неправильно заполнено поле электронной почты.',
			'max'   => 'Значение поля E-mail должно быть до :max символов.',
			'min'   => 'Значение поля E-mail должно быть от :min символов.',
		],
		'phone' => [
			'required' => 'Поле '.trans('forms.phone').' обязательно для заполнения.',
			'max'      => 'Значение поля '.trans('forms.phone').' должно быть до :max символов.',
			'min'      => 'Значение поля '.trans('forms.phone').' должно быть от :min символов',
		],
		'message' => [
			'required' => 'Поле '.trans('forms.message').' обязательно для заполнения.',
		],
	],
